...
public class K_aboutVO {
	...
	public void setCompname_kr(String compname_kr) {
		this.compname_kr = compname_kr;
	}
	public String getCompname_en() {
		return compname_en;
	}
	public void setCompname_en(String compname_en) {
		this.compname_en = compname_en;
	}
