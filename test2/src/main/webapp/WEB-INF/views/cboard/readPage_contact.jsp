		...
		<div id="paper">
			...
			<div id="company_profile">
				...
				<div id="company_info">
					...
					<ul id="page_move">
						<!--페이지 이동-->
						<li><a href="news?code=${k_contactVO.companyCode}">News</a></li>
						<li><a href="readPage_home?code=${k_contactVO.companyCode}">Home</a></li>
						<li><a href="readPage_about?code=${k_contactVO.companyCode}">About</a></li>
						<li><a
							href="readPage_product?code=${k_contactVO.companyCode}">Product</a></li>
						<li class="on"><a
							href="readPage_contact?code=${k_contactVO.companyCode}">Contact</a></li>
					</ul>
				</div>
				<div id="commu">
					<!-- 
					...
					<p id="edit">
						<a href="update_contact?cid=${k_contactVO.cid}&code=${k_homeVO.companyCode}">편집</a>
					</p>
				</div>
				</div>
			</div>
