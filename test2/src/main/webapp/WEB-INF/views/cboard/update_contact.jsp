        ...
        <div id="paper">
               ...
               <img src="../resources/img/${k_homeVO.pimage}" onclick="doImgPop('../resources/img/${k_homeVO.pimage}')"/> 
                ...
                <div id="company_info"> <!--기업정보-->
                    ...
                    <ul id="page_move"> <!--페이지 이동-->
                        ...
                        <li class="on"><a href="readPage_contact?code=${k_homeVO.companyCode}">Contact</a></li>
                    </ul>
                </div>
                <div id="commu"><!-- 
            ...
            <form id="form4" name="joinForm"role='form' method="post" >
                    <div class="array">
                        ...
                        <input type="hidden" name="companyCode"	value="${k_contactVO.companyCode}"> 
