...
<script>
	...
	function productadd(code) {
		var code = code;
		var popUrl = "./register_product?code=" + code;
		...
		<div id="paper">
			...
			<div id="company_profile">
				...
				<div id="company_info">
					...
					<ul id="page_move">
						<!--페이지 이동-->
						<li><a href="news?code=${k_aboutVO.companyCode}">News</a></li>
						<li><a href="readPage_home?code=${k_aboutVO.companyCode}">Home</a></li>
						<li><a href="readPage_about?code=${k_aboutVO.companyCode}">About</a></li>
						<li class="on"><a
							href="readPage_product?code=${k_aboutVO.companyCode}">Product</a></li>
						<li><a href="readPage_contact?code=${k_aboutVO.companyCode}">Contact</a></li>
					</ul>
				</div>
				<div id="commu">
					<!-- 
					...
					<div id="follow_num_home1">
						...
						<p id="edit">
							<a href="#" onclick="productadd('${k_aboutVO.companyCode}')">제품등록</a>
						</p>
					</div>
				</div>
			</div>
							...
							<div class="product_memo">
								...
								<div class="product_add">
									<input type="hidden" name="companyCode"
										value="${list.companyCode}"> <input type="hidden"
