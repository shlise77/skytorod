			...
			<div id="company_profile">
				...
				<div id="company_info">
					...
					<ul id="page_move">
						...
						<li class="on"><a
							href="readPage_about?code=${k_aboutVO.companyCode}">About</a></li>
						<li><a href="readPage_product?code=${k_aboutVO.companyCode}">Product</a></li>
				...
				<div id="follow_num_home1">
					...
					<p id="edit">
						<a
							href="update_about?aid=${k_homeVO.hid}&code=${k_homeVO.companyCode}">편집</a>
					</p>
				</div>
			</div>
