        ...
        <div id="paper">
            ...
            <div id="company_profile">
                ...
                <div id="company_info"> <!--기업정보-->
                    ...
                    <div id="company_type">2.About</div>
        ...
        <div id="join_wrap">
            <form id="form2" name="joinForm" method="post">
                <div class="data_box">
                    ...
                    <div class="array">
                        <span>주소</span>
                        <input class="info_enter" type="text" id="input10" name="address" />
                    </div>
                    <div class="array">
                        <div class="h_array">
                            <span>전화번호</span>
                            <input class="h_infoBox" type="text" id="input11" name="phonenumber" />
                        </div>
                        <div class="h_array">
                            <span class="t_p">Fax</span>
                            <input class="h_infoBox" type="text" id="input12" name="fax" />
                        </div>
                    </div>
                    <div class="array">
                        <span>사업장 현황</span>
                    ...
                    <button class="prev_page" type="submit" onclick="history.go(-1);" >이전</button>
                    <button class="next_page" type="submit" >다음</button>
                </div>
            </form>
        </div>
    </section>
