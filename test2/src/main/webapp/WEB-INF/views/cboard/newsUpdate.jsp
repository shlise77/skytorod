						...
						<div id="share_input">
							...
							<ul class="title_box">
								<c:forEach items="${updateBoard}" var="updateBoard">
									<li class="name">
									<input type="hidden" name="cbid" id="cbid" value="${updateBoard.cbid}" /> 
									<input type="hidden" name="cbwarea" id="cbwarea" value="${updateBoard.cbwarea}" /> 
									<input type="hidden" name="cbreadid" id="cbreadid" value="${updateBoard.cbreadid}" /> 
									<input type="hidden" name="cbuserid" id="cbuserid" value="${updateBoard.cbuserid}" />
									<input type="hidden" name="cbregdate" id="cbregdate" value="${updateBoard.cbregdate}" />
									<input type="hidden" name="fakeimg" value="${updateBoard.cbimage}" />
									${updateBoard.company}(${updateBoard.first}${updateBoard.last})</li>

									<li><textarea class="record" name="cbcontent" wrap="hard"
											onkeyup="resize(this)">${updateBoard.cbcontent}</textarea></li>
								</c:forEach>
