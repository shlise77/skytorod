...
<script>
	...
	function opencompany() {
		...
		var Url = "./searchcompanylist";
		var Option = "width=500, height=500, resizable=no, scrollbars=no, status=yes;"; 
		...
		<div id="paper">
			...
			<div id="search_box">
				...
				<ul id="search_add">
					...
					<li class="search2">
						<a href="../cboard/register_home">회사등록</a>
					</li>
					<li class="search2">
					</li>
					<li class="search2">
						<a href="#" onclick="opencompany();">회사찾기</a>
					</li>
				</ul>
			...
			<div id="contents_wrap">
				<ul id="search_list">
					<li><c:forEach items="${companylist}" var="companylist">
							<div>
								<div><span style='cursor: pointer;'
										onclick="gomycompany('${companylist.companyCode}');">
									${companylist.comname_kr}(${companylist.comname_en})
									&nbsp;&nbsp;&nbsp;&nbsp;${companylist.repname}
									&nbsp;&nbsp;&nbsp;&nbsp;${companylist.country}</span>
								</div>
							</div>
						</c:forEach></li>
				</ul>
