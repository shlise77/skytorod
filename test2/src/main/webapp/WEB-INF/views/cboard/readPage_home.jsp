	...
	<section id="container">
		<div id="paper">
			...
			<div id="company_profile">
				...
				<div id="company_info">
					...
					<ul id="page_move">
						<!--페이지 이동-->
						<li><a href="news?code=${k_homeVO.companyCode}">News</a></li>
						<li class="on"><a href="readPage_home?code=${k_homeVO.companyCode}">Home</a></li>
				...
				<div id="follow_num_home1">
					...
					<p id="edit">
						<a href="update_home?hid=${k_homeVO.hid}&code=${k_homeVO.companyCode}">편집</a>
					</p>
				</div>
			</div>
		...
		<div id="contents_wrap">
			...
			<div id="business_photo">
				...
				<img src="../resources/img/${k_homeVO.companyimg}" onclick="doImgPop('../resources/img/${k_homeVO.companyimg}')"/> 
			</div>
			<p>도시/국가</p>
			<div class="white_box" id="company_greeting">
