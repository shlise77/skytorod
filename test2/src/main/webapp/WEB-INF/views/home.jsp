...
<body onload="javascript:reload();">
	<c:if test="${sessionScope.login == 'adminklaiver'}">
		<header>
			<ul id="icon">
		...
		<div>
			<c:forEach items="${mlist}" var="mlist">
				<a href="./admin/member?userid=${mlist.userid}&code=${mlist.companyCode}"><div>
				${mlist.companyCode}&nbsp;&nbsp;
				<font style="color:red">${mlist.userid}</font>&nbsp;&nbsp;
				${mlist.first}${mlist.last}&nbsp;&nbsp;
				${mlist.title}&nbsp;&nbsp;
				${mlist.repname}&nbsp;&nbsp;
				${mlist.country}
				</div>	</a>
