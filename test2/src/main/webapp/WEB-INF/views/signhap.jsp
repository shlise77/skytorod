            ...
            <form id="stage4" name="commonForm"role="form" method="post">
                <div class="info_box">
                    ...
                    <ul id="Input_information">
                        <li><span id="Span1">${jo.first}</span><span id="Span2">${jo.last}</span></li>
                        <li><span id="Span3">${jt.company}</span></li>
                        <li><span id="Span4">${jt.title }</span></li>
                        <li><span id="Span5">${jt.industry}</span></li>
                        <li><span id="Span6">${jit.country }</span></li>
                        <li><span id="Span7">${jit.city }</span></li>
                    </ul>
                </div>
